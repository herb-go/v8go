...
[![Go Report Card](https://goreportcard.com/badge/github.com/herb-go/v8go)](https://goreportcard.com/report/github.com/herb-go/v8go)
[![Go Reference](https://pkg.go.dev/badge/github.com/herb-go/v8go.svg)](https://pkg.go.dev/github.com/herb-go/v8go)
...
```go
import v8 "github.com/herb-go/v8go"
```
...
Go Reference & more examples: https://pkg.go.dev/github.com/herb-go/v8go
